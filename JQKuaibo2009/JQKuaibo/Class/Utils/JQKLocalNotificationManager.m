...
#import "JQKLocalNotificationManager.h"

@implementation JQKLocalNotificationManager

+ (instancetype)sharedManager {
    static JQKLocalNotificationManager *_sharedManager;
