...
@interface JQKLaunchView ()
{
    UIImageView *_imageView;
}
@end

@implementation JQKLaunchView
...
- (instancetype)init {
    ...
    if (self) {
        ...
        NSString *launchImagePath = [[NSBundle mainBundle] pathForResource:@"launch_image2" ofType:@"jpg"];
