//
//  JQKVersionUpdateViewController.m
//  JQKuaibo
//
...
@interface JQKVersionUpdateViewController ()

@end

@implementation JQKVersionUpdateViewController
...
- (void)addAllUI {
    ...
    titleLabel.font = [UIFont systemFontOfSize:kWidth(36.)];
    ...
    subTitleLabel.font = [UIFont systemFontOfSize:kWidth(16)];
    ...
    [subTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self.view);
        make.top.mas_equalTo(titleLabel.mas_bottom).mas_offset(kWidth(30));
    }];
    }
    ...
    updateBtn.titleLabel.font = [UIFont systemFontOfSize:kWidth(24)];
    ...
    [updateBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(kWidth(55.));
    }];
    }
    @weakify(self);
