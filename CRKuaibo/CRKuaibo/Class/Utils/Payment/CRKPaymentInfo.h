...
typedef NS_ENUM(NSUInteger, CRKPaymentStatus) {
    CRKPaymentStatusUnknown,
    CRKPaymentStatusPaying,
    CRKPaymentStatusNotProcessed,
    CRKPaymentStatusProcessed
};

@interface CRKPaymentInfo : NSObject
