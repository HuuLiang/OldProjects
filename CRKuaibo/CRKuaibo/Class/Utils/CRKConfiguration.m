...
@implementation CRKConfiguration

+ (instancetype)sharedConfig {
    static CRKConfiguration *_config;
...
+ (instancetype)sharedStandbyConfig {
    static CRKConfiguration *_standbyConfig;
...
+ (instancetype)configWithName:(NSString *)configName {
    ...
    CRKConfiguration *config = [[self alloc] initWithDictionary:configDic];
    return config;
}
