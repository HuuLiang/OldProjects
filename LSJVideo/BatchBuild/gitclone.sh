...
GIT_PROJECT_NAME="LSJVideo"

RESPO_URL="git@git.coding.net:Liang-_-/$GIT_PROJECT_NAME.git"
...
eval "$GIT_EXEC clone $RESPO_URL $LOCAL_PROJECT_DIR --branch iappPay > /dev/null 2>&1"
