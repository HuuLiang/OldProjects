...
+ (instancetype)sharedStandbyConfig {
    static LSJConfiguration *_standbyConfig;
...
+ (instancetype)configWithName:(NSString *)configName {
    ...
    LSJConfiguration *config = [[self alloc] initWithDictionary:configDic];
    return config;
}
